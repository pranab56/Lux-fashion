    ...
    const handleContact=e=>{
      ...
      .then((result) => {
        if(result.success){
          ...
          const profile={name,date,number,gender,address,image};
...
<div class="relative mt-2 z-0 mb-6 group">
      <textarea rows={3} type="text" name="address" id="floating_repeat_password" class="block py-2.5 px-0 w-96 mx-auto text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
