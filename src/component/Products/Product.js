        ...
        <div class="relative mt-10">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute bottom-0 p-8 w-full opacity-0 group-hover:opacity-100">
                        ...
                        <button class="bg-transparent font-medium text-base leading-4 border-2 border-red-500 border-rose-500 rounded-3xl py-3 w-full mt-2 text-white hover:bg-rose-500">Quick View</button>
                    </div>
                </div>
