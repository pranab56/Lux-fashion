        ...
        <div className="relative mt-10">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute bottom-0 p-8 w-full opacity-0 group-hover:opacity-100">
                        ...
                        <button onClick={()=>handlebuy(product)} className="bg-transparent font-medium text-base leading-4 border-2 border-red-500 border-rose-500 rounded-3xl py-3 w-full mt-2 text-white hover:bg-rose-500">Buy Now</button>
                    </div>
                </div>
